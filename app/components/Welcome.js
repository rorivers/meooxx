      ...
      <Layout>
        <Header>
          <Menu theme="dark" mode="horizontal">
            ...
            <Menu.Item key="2">
              <Link to={`${match.url}/PersonalProfile`}>个人的简历</Link>
            </Menu.Item>
            <Menu.Item key="3">
        ...
        <Layout>
          ...
          >
            ...
            >
                ...
                render={() => (
                  ...
                  >
                    ...
                    >
                      <a
                        target="_blank"
                        href="https://github.com/meooxx/ReactSPA"
                      >
                        github{" "}
                      </a>
                      <p>
                        {" "}
                        showtopic用的cnode社区提供的API做的,
                        个人简历就是个人简历
                      </p>
                    </span>
                  </div>
              ...
              <Route path={`${match.url}/showtopics`} component={ShowTopics} />
              <Route
                path={`${match.url}/PersonalProfile`}
        ...
        >
          super-q's space Design by{" "}
          <a target="_blank" href="https://github.com/meooxx/ReactSPA">
            super-q{" "}
          </a>
        </Footer>
      </Layout>
...
const welcome = connect(mapStateToProps)(Home);
