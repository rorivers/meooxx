		...
		return(
			<div className='cell-comment'>
				...
				<div className='user-comment'>
					<span 
							className=					'comment-loginname'>
						<a onClick={this.handleAvatarClick}
							href='#' >
							<img
						  ...
						  <span className='comment-reply-info'>
							...
							{	(authorLoginname == loginname)&& <span className='reply-author'> 作者</span> }
						</span>
				...
				<div 
					...
					dangerouslySetInnerHTML={	
						this.createComment(reply.content) 
					} >
				</div>
				
				<span
					className={ hidden &&'comment-reply-hidden' } >
					<ReplyTextarea
